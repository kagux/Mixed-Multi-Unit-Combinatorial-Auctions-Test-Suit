...
public class CenteredDistributionFactoryTest{

    @Test
     public void correctCenterValue(){
        assertEquals("center", 0, distribution("1", "0.5").getCenter());
        assertEquals("center", 1, distribution("2", "0.5").getCenter());
        assertEquals("center", 4, distribution("5", "0.5").getCenter());
    }
    ...
    private CenteredDistribution distribution(String centerValue, String alphaValue) {
        ...
        return (CenteredDistribution)new CenteredDistributionFactory(centeredDistrPane).create();
    }
